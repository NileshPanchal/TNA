...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { case_date: @case.case_date, description: @case.description, name: @case.name, news_feed: @case.news_feed }
    end
  ...
  test "should update case" do
    put :update, id: @case, case: { case_date: @case.case_date, description: @case.description, name: @case.name, news_feed: @case.news_feed }
    assert_redirected_to case_path(assigns(:case))
  end
